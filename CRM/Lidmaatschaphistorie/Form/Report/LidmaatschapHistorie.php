    ...
    $this->_columns = array(
      ...
      array(
        ...
        'filters' => array(
          ...
          array('title' => ts('Activity Type'),
            ...
            'default' => $lidmaatschap_config->get_lidmaatschap_historie_activity_id(), // BOS1502448 vnv.nl - lidmaatschap historie - set default on lidmaatschap historie
          ),
          'status_id' =>
          array('title' => ts('Activity Status'),
            'operatorType' => CRM_Report_Form::OP_MULTISELECT,
      ...
      array(
        ...
        array(
          ...
          /*
           * BOS1502448 vnv.nl - lidmaatschap historie
           * The want to see the contact id of the contact of the activity
           */
          'id' =>
          array(
            'no_display' => TRUE,
